          ...
          <tbody>
            ...
            @foreach ($order_items as $item)
              <tr wire:key="53">
                ...
                <td class="py-4">IDR {{ number_format($item['unit_amount'], 0, '', '') }}</td>
                <td class="py-4">
                  <span class="text-center w-8">{{$item->quantity}}</span>
                </td>
                <td class="py-4">IDR {{ number_format($item['total_amount'], 0, '', '') }}</td>
              </tr>
    ...
    <div class="md:w-1/4">
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex justify-between mb-2">
          ...
          <span class="font-semibold">IDR {{ number_format($order['grand_total'], 0, '', '') }}</span>
        </div>
